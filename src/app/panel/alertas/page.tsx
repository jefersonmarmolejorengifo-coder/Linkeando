...
export default function PanelAlertas() {
  ...
  return (
    <div className="px-4 pt-4">
      <button onClick={() => router.back()} className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-verde-500 mb-3 bg-transparent border-none cursor-pointer">
